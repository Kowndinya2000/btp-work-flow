...
function file_info() {
    ...
    */
    ...
    this.GetAnnotationPath = function () {
        if((this.mode=='i') || (this.mode=='c') || (this.mode=='f') || (this.mode=='im') || (this.mode=='mt')) return 'Annotations/example_folder/' +  this.im_name.substr(0,this.im_name.length-4) + '.xml';
    };
